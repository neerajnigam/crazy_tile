...
public class AssetLoader {
	...
	public static Texture texture, logoTexture , icon_texture;
	...
	public static void load() {
		...
		// ------------- loads textures ----------------
		texture = new Texture(Gdx.files.internal("data/crazyBalls.png"));
		texture.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
		
		icon_texture = new Texture(Gdx.files.internal("data/ic_crazy_balls.png"));
		...
		tileLogo = new TextureRegion(texture, 0, 0, 300, 70);
